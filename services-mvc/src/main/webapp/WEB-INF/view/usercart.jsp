...
<body>
	...
	<center>
		...
		<table class="table table-dark table-striped">
			...
			<tbody>
				<c:forEach items="${cartList.cartList}" var="item">
					<tr>
						...
						<td><a href="/cart/add/${userId}/${item.name}"></a>
							<form method="post" action="/cart/add/${userId}/${item.name}"
								class="inline">
						...
						<td><a href="/cart/delete/${userId}/${item.name}"></a>
							<form method="post" action="/cart/delete/${userId}/${item.name}"
								class="inline">
								<input type="hidden" name="extra_submit_param"
									value="extra_submit_value">
								<button type="submit" name="submit_param" value="submit_value"
